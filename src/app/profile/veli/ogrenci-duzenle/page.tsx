...
export default function OgrenciDuzenlePage() {
  return (
    <Suspense fallback={<div className="flex justify-center items-center h-64"><Loader2 className="w-8 h-8 animate-spin text-pink-500" /></div>}>
      <OgrenciDuzenleInner />
    </Suspense>
  )
}
